...
<body>
	<div id="logotype" style="margin:0 auto;float: none;">
		<img src="../img/logo2014.png" alt="Siempre Vivo Reggae logo" width="200" height="152">
	</div>
...
<fieldset id="sendEmail">
	...
	<form name="emailForm" id="emailForm" method="POST" action="enviar.php"  enctype="multipart/form-data">
        <div class="row"><label>Artista(*):</label> <input type="text" name="artista" id="artista" size="100" /></div>
        <div class="row"><label>Link de Youtube o Soundcloud(*):</label> <input type="text" name="link" id="link" size="100" /></div>
        <div class="row"><label>Ciudad(*):</label> <input type="text" name="ciudad" id="ciudad" size="100" /></div>
        <div class="row"><label>Email de contacto(*):</label> <input type="text" name="contacto" id="contacto-" size="100" /></div>
        <div class="row"><label>Nombre del representante(*):</label> <input type="text" name="representante" id="representante" size="100" /></div>
